...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[120vh]  flex flex-col items-center py-0 md:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            Juntos, podemos criar um futuro melhor, mais rápido e mais inteligente.
            Tecnologia e colaboração: a chave para desbloquear sonhos. <br />
          </span>
        )}
      </motion.h2>
      {/* Lid */}
